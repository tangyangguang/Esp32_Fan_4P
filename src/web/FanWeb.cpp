...
static const char FAN_TIMER_INPUT_END[] PROGMEM =
    ...
    "<div class=nav2><a class=btn href='/config'>Settings</a><a class=btn href='/esp32base/logs'>Logs</a><a class=btn href='/esp32base/wifi'>WiFi</a></div>"
    "<script>"
    "var rem=";
...
static const char CONFIG_AUTO_END2[] PROGMEM = ">Disabled</option></select><div class=help>Restore last speed and timer after reboot.</div></div></div>"
    ...
    "<div class=nav2><a class=btn href='/fan'>Fan</a><a class=btn href='/esp32base/logs'>Logs</a><a class=btn href='/esp32base/wifi'>WiFi</a></div>"
    "<script>"
